      ...
      const salaryPage = document.querySelector("#Salary-Page")


      function hideAllPages() {
        const allPages = [NewExamPage,salaryPage, PreviousExamPage,homePage, homeworkPage,profilePage ,resultPage,PreviousClassTestResult,PreviousSchoolExamResult, examPage, attendancePage, PreviousAttendancePage, noticePage, routinePage, galleryPage, loginPage];
      ...
      SalaryPageBtn.addEventListener("click", function(){
        hideAllPages();

        headerName.innerHTML = "Salary Page";
